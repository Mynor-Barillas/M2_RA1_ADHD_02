...
<body>
    ...
    <div class="container">
        ...
        <form action="crud_departamentos.php" method="post">
            ...
            <input type="text" name="txt_nombre" id="txt_nombre" class="form-control" value="<?php echo $datos['nombre_depto']; ?>">
            <br>
            <label for="txt_region" class="form-label">Codigo Region</label>
            <input type="text" name="txt_region" id="txt_region" class="form-control" value="<?php echo $datos['cod_region']; ?>">
            <br>
