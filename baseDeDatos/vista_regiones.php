...
<body>
  <div class="container">
    ...
    <div class="container">
      ...
      <a href="vista_regiones_card.php" class="btn btn-secondary animate__animated animate__bounce animate__delay-2s">Vista con Cartas</a>
      <br>
      <br>
      <table class="table table-striped table-success table-border border-dark animate__animated animate__slideInLeft">
        <thead>
          <tr>
