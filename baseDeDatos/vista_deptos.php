...
<body>
    ...
    <div class="container">
        ...
        <a href="vista_deptos_card.php" class="btn btn-secondary animate__animated animate__bounce animate__delay-2s">Vista con Cartas</a>
        <br>
        <br>
        <br>
        <table class="table table-striped table-info table-border border-dark animate__animated animate__jackInTheBox">
            <thead>
                <tr>
                    <th>Codigo Departamentos</th>
                    <th>Nombre</th>
                    <th>Codigo region</th>
                    <th>Acción</th>
                </tr>
